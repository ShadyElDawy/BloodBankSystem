...
<body>
  ...
  <nav class="navbar">
    ...
    <a class="btn" href="home.php"><span class="glyphicon glyphicon-home"></span>            Home</a>

    <a class="btn  active" href="don.php"><span class="glyphicon glyphicon-tint"></span>      Places of donation</a>
  ...
  <div id="red"  style="margin-top: 5px">
      <div id="wh" class="row">
          <div class="col-md-8 col-md-offset-2">
            <div  class="container">
    <br/>
    <h1 align="center">Search for Places</h1>
